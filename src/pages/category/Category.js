        ...
        <Container className={classes.root}>
            ...
            <TableContainer component={Paper} classes={{ root: classes.customTableContainer }}>
                <Table stickyHeader>
                    ...
                    <TableBody>
                        {categoryList.length && categoryList.slice(page * rowsperpage, page * rowsperpage + rowsperpage).map((row) => (
                            <TableRow key={row.id}>
                                <TableCell  >
                                    {row.id}
                                </TableCell>
                                ...
                                <TableCell >
                                    <Avatar alt="Remy Sharp" src={`http://147.139.33.186/uploads/categories/${row.categoryImage}`} />
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
